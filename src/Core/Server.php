...
use HerbieZ\WebWeChat\Support\System;
use HerbieZ\WebWeChat\Support\FileManager;
...
//            '_' => time() * 1000 . random_int(1, 999)
    ...
    public function setSyncHandler(\Closure $closure)
    {
        MessageHandler::getInstance()->setSyncCheck($closure);
    }
}